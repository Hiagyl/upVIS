                ...
                >
                    <div className="flex justify-between items-start mb-6">
                        <div className="flex flex-col gap-2">
                            ...
                            <p className={`text-xs font-black uppercase tracking-widest ${card.isPrimary ? 'text-amber-400' : 'text-slate-600'}`}>
                                {card.label}
                            </p>
                            {/* Visual anchor line */}
                    ...
                    <div className="flex items-baseline gap-2">
                        ...
                        <span className={`text-xl font-bold ${card.isPrimary ? 'text-amber-500' : 'text-slate-400'}`}>₱</span>
